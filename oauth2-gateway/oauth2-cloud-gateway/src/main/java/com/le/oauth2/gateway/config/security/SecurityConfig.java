...
import com.le.oauth2.gateway.exception.RequestAccessDeniedHandler;
import com.le.oauth2.gateway.exception.RequestAuthenticationEntryPoint;
import com.le.oauth2.gateway.filter.CorsFilter;
...
/**
 * 网关的OAuth2.0资源的配置类
 * 由于spring cldou gateway使用的Flux，因此需要使用@EnableWebFluxSecurity注解开启
 */
@Configuration
