package com.le.oauth2.common.security.filter;
...
import com.le.oauth2.common.model.RequestConstant;
import com.le.oauth2.common.model.TokenConstant;
...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (StrUtil.isNotBlank(token)) {
            ...
            // 权限
            String[] authorities = tempJsonArray.toArray(new String[tempJsonArray.size()]);
            // 放入LoginVal
